...
function isJDCoupon(title) {
  if (title.indexOf('京东') > -1)
    ...
    return true
  else if (title.indexOf('3C家电') > -1)
    return true
  else if (title.indexOf('京东国际') > -1)
    return true
  else if (title.indexOf('运费') > -1)
    return true
  else if (title.indexOf('食品饮料') > -1)
    return true
  else if (title.indexOf('数码') > -1)
    return true
  else if (title.indexOf('学生') > -1)
    return true
  else if (title.indexOf('自营') > -1)
    return true
  else if (title.indexOf('健康') > -1)
    return true
  else if (title.indexOf('大药房') > -1)
    return true
  else if (title.indexOf('调味料') > -1)
    return true
  else if (title.indexOf('个人护理') > -1)
    return true
  else if (title.indexOf('洗护') > -1)
    return true
  else if (title.indexOf('鲜花园艺') > -1)
    return true
  else if (title.indexOf('美妆') > -1)
    return true
  else if (title.indexOf('百元生活费') > -1)
    return true
  else if (title.indexOf('PLUS') > -1)
    return true
  else if (title.indexOf('幸运转盘') > -1)
    return true
  else if (title.indexOf('极速') > -1)
    return true
  else if (title.indexOf('冷饮') > -1)
    return true
